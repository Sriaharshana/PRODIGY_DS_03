...
# 2. Load datasets
train_data = pd.read_csv(r'C:\Users\SRI AHARSHANA G B\Desktop\task\Task 3\twitter_training.csv', names=columns)
validation_data = pd.read_csv(r'C:\Users\SRI AHARSHANA G B\Desktop\task\Task 3\twitter_validation.csv', names=columns)
